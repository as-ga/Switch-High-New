...
export const metadata: Metadata = {
  title: "Best Digital Marketing Agency in India | Switch High",
  description:
  ...
  openGraph: {
    title: "Best Branding & Digital Marketing Agency in India | Switch High",
    description:
      "Elevate your brand with Switch High, the best branding agency in India. We craft impactful brand strategies to help your business stand out and succeed.",
    url: "https://www.doorsstudio.com/",
    siteName: "Switch High",
    images: [
      {
...
export default function RootLayout({
  ...
  return (
    <html lang="en" data-scroll-behavior="smooth" className={`${poppins.variable} scroll-smooth`}>
